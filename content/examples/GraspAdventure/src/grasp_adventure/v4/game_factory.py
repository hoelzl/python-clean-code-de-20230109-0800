...
class GameFactory:
    ...
    def create_world(
        ...
        if self.world is None:
            location_dict = GameFactory._create_location_dict(location_descriptions)
            self.world = World(
    ...
    def _create_location_dict(
        ...
        >>> GameFactory._create_location_dict(
        ...
        """
        locations = GameFactory._create_location_dict_without_connections(
