...
class WorldFactory:
    ...
    def create(
        ...
        >>> WorldFactory().create([{"name": "A", "connections": {"east": "B"}},
        ...
        """
        return World(
            location_dict=(WorldFactory._create_location_dict(location_descriptions)),
    ...
    def _create_location_dict(
        ...
        >>> WorldFactory._create_location_dict(
        ...
        """
        locations = WorldFactory._create_location_dict_without_connections(
            location_descriptions
        )
        WorldFactory._build_connections_for_all_locations(
